                            ...
                            <form action="/produk/{{ $item->id }}" method="post">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Pilih Produk</label>
                                            <select name="pabrik_id" class="form-select"
                                                aria-label="Default select example">
                                                <option selected>Pilih Pabrik</option>
                                                @foreach ($pabriks as $pabrik)
                                                    <option value="{{ $pabrik->id }}"  @if ($pabrik->id == $item->pabrik_id) @selected(true)  @endif> {{ $pabrik->nama_pabrik }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Jumlah Stok</label>
                                            <input type="number" name="jumlah_stok" value="{{ $item->stok }}" class="form-control"
