  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="mb-3">
            ...
            <input type="text" name="nama_pabrik" id="exampleInputEmail1" aria-describedby="emailHelp">
      </div>
      <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Alamat Pabrik</label>
            <input type="text" name="alamat_pabrik" id="exampleInputEmail1" aria-describedby="emailHelp">
      </div>
      <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Contact Pabrik</label>
            <input type="text" name="contact_pabrik" id="exampleInputEmail1" aria-describedby="emailHelp">
      </div>
      </div>
